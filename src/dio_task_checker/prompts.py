...
PROMPT_TEMPLATE = """Ты — ассистент-редактор заданий для сотрудников. Твоя задача — оценивать задания по пяти ключевым критериям и предоставлять развернутую обратную связь.
